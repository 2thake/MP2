...
v_mw = 0# * 60 * 60 # m/s
scale = 3000000
jupiter = Planet("Jupiter", 1.898e27, [2.657301572545939E+00, 4.244832633235739E+00, -7.706081756999565E-02], [-6.480998680299733E-03, 4.362422858591558E-03, 1.268648293569800E-04+v_mw], radius=scale*69911/AU, texture= os.path.join("textures", "Jupiter_2k.png"))
...
saturn  = Planet("Saturn", 5.683e+26, [9.211655736771199E+00, -2.998507001947348E+00, -3.146252679038145E-01], [1.415075980682737E-03, 5.293746502200081E-03, -1.483576235830070E-04+v_mw], radius=scale*58232/AU, texture=os.path.join("textures", "Saturn_2k.png"))
sun     = Planet("Sun", 1.989e30, [-7.225998149491247E-03, -3.805650685824385E-03, 2.018536538194618E-04], [5.902551462508057E-06, -5.950748571015161E-06, -7.997101158836507E-08+v_mw], radius=scale/7*6.9634e5/AU, texture=os.path.join("textures", "Venus_2k.png")) # the sun here is assumed to start at zero postion
uranus  = Planet("Uranus", 8.681e25, [1.183100464891022E+01, 1.560581328660078E+01, -9.531293561809405E-02], [-3.163272718481608E-03, 2.192851241912579E-03, 4.915878565000892E-05+v_mw], radius=scale*25362/AU, texture=os.path.join("textures", "Uranus_2k.png"))
neptune = Planet("Neptune", 1.024e+26, [2.985499980827878E+01, -1.358647720327443E+00 , -6.600608487568795E-01], [1.220565817760229E-04, 3.154546893302934E-03, -6.780559909533712E-05+v_mw], radius=scale*24624/AU, texture=os.path.join("textures", "Neptune_2k.png"))
...
initial4 =  RungeKutta4_v1(vector, 200, 4, C_val) #Initial 4 using Runge Kutta to put into ABM
Storage = ABM_4(initial4, 200, N, C_val)
